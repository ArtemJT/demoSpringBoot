...
public class CustomerController {
    ...
    public List<RequestReadDto> getAllCustomerOrders(@RequestParam Integer id) {
        return requestMapper.toReadDtoCol(customerService.getAllRequestsByCustomerId(id));
    }
}
